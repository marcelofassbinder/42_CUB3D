SRC = src/main.c src/utils.c src/raycasting.c src/move_player.c src/parsing/parsing.c\
		src/parsing/map.c
OBJ = src/main.o src/utils.o src/raycasting.o src/move_player.o src/parsing/parsing.o\
		src/parsing/map.o
